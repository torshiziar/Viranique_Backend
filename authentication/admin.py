...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('photo', 'name', 'last_name', 'phone', 'organization','remain_account',)}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'email', 'phone', 'organization', 'password1', 'password2','remain_account'),
        }),
    )
    search_fields = ('email',)
    ordering = ('email',)
