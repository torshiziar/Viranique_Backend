...
class HistorySerializer(serializers.Serializer):
    #======= max_value nabayad ==1000  bashad faghat!!!!)
    ...
    #==NEW===
    sensor_type = serializers.IntegerField(max_value=99999)
    sensor_list = serializers.ListField(child=serializers.IntegerField(max_value=99999))
    ...
    def get_data(self, obj):
        ...
        #=== NEW CODE===========
        responses, gate, type=influx_query(obj['sensor_list'], obj['start_time'], obj['stop_time'], self.get_timestamp(obj))
        result={}
        result['responses']=responses
        result['_measurement']=type
        # result['owner']=owner
        result['gateway']=gate
        # result['node']=node
        #=========================
